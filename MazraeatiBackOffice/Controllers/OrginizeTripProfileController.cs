...
{
    public class OrginizeTripProfileController : BaseController
    {
        ...
        public OrginizeTripProfileController(IRepository<TripProfile> tripProfileRepository, IRepository<Trip> tripRepository, IRepository<Country> countryRepository ,
        ...
        public IActionResult Index()
        {
            ...
            var model = _TripProfileRepository.Table.Where(t => t.TypeId == 1).OrderByDescending(a => a.Id).Select(c => c.ToModel(countries, Cities, null));
        ...
        public IActionResult Index(string search)
        {
            ...
            List<Country> countries = _CountryRepository.Table.ToList();
            List<City> Cities = _cityRepository.Table.ToList();
            var model = _TripProfileRepository.Table.Where(t => t.TypeId == 1).OrderByDescending(a => a.Id).Where(a => a.Name.Contains(search) || a.Description.Contains(search)).Select(c => c.ToModel(countries, Cities, null));
            ViewBag.activePage = "منظمي حفلات المزارع";
        ...
        public IActionResult TripIndex(int id)
        {
            ...
            ViewBag.activePage = "انشطة منظمي حفلات المزارع";
        ...
        public IActionResult TripImages(int id)
        {
            ...
            ViewBag.activePage = "صور انشطة منظمي حفلات المزارع";
