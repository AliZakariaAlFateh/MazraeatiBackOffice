...
namespace MazraeatiBackOffice.Controllers
{
    ...
    public class HomeController : BaseController
    {
        ...
        public HomeController(IRepository<Farmer> FarmerRepository, IRepository<Trip> TripRepository
            ...
            , IWebHostEnvironment hostEnvironment, TimeCacheService timeCache
            , IRepository<NotificationsFarm> notificationsFarm, IUnitOfWork UnitOfWork)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.TotalVIPFarmer = _FarmerRepository.Table.Count(s => s.CountryId == 2 && s.IsVIP == true  && !farmerBlackListIds.Contains(s.Id));
