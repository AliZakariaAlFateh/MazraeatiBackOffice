...
namespace MazraeatiBackOffice.Controllers.FarmControllers
{
    public class ExtraFeatureController : BaseController
    {
        ...
        public ExtraFeatureController(IRepository<Lookup> lookupRepository, 
        ...
        public IActionResult Index()
        {
            ...
            var model = _LookupRepository.Table.Where(a => a.LookupCode == "FarmerExtraFeatureType" 
            || a.LookupCode == "TripExtraFeatureType" || a.LookupCode == "Currency" 
            || a.LookupCode == "FarmerPriceType" || a.LookupCode == "ReservationType"
            || a.LookupCode== "HeaderTitleForUserApp" || a.LookupCode== "BannerForShowAllFarms")
                .Select(a => a.ToModel());
        ...
        public IActionResult Create(LookupValueModel model, IFormFile formFile)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (formFile != null)
                        model.Image = "ImageForAllFarmsForUserApp/" + GenericFunction.UploadedFile(formFile, webHostEnvironment, "ImageForAllFarmsForUserApp");
