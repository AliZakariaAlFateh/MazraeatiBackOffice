...
{
    public class OrginizeTwoTripProfileController : BaseController
    {
        ...
        public OrginizeTwoTripProfileController(IRepository<TripProfile> tripProfileRepository, IRepository<Trip> tripRepository, IRepository<Country> countryRepository,
        ...
        public IActionResult Index()
        {
            ...
            var model = _TripProfileRepository.Table.Where(t => t.TypeId == 5).OrderByDescending(a => a.Id).Select(c => c.ToModel(countries, Cities, null));
            ViewBag.activePage = "منظمي الرحلات";
            return View(model);
        }
        ...
        public IActionResult Index(string search)
        {
            ...
            List<Country> countries = _CountryRepository.Table.ToList();
            List<City> Cities = _cityRepository.Table.ToList();
            var model = _TripProfileRepository.Table.Where(t => t.TypeId == 5).OrderByDescending(a => a.Id).Where(a => a.Name.Contains(search) || a.Description.Contains(search)).Select(c => c.ToModel(countries, Cities, null));
            ViewBag.activePage = "منظمي الرحلات";
        ...
        public IActionResult TripIndex(int id)
        {
            ...
            ViewBag.activePage = "انشطة منظمي الرحلات";
        ...
        public IActionResult TripImages(int id)
        {
            ...
            ViewBag.activePage = "صور انشطة منظمي الرحلات";
