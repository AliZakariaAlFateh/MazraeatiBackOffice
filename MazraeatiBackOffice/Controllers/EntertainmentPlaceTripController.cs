...
{
    public class EntertainmentPlaceTripController : BaseController
    {
        ...
        public EntertainmentPlaceTripController(IRepository<Country> countryRepository, IRepository<City> cityRepository , IRepository<TripProfile> TripProfileRepository, IRepository<Trip> TripRepository, 
        ...
        public IActionResult Index()
        {
            ...
            var model = _TripRepository.Table.Where(t => t.TypeId == 7).OrderByDescending(a => a.Id).Select(c => c.ToModel(Countries, Cities,null,null));
            ViewBag.activePage = "اماكن ترفهية";
            return View(model);
        }
        ...
        public IActionResult Index(string search)
        {
            ...
            var Countries = _countryRepository.Table.ToList();
            var Cities = _cityRepository.Table.ToList();
            var model = _TripRepository.Table.Where(t=>t.TypeId == 7).OrderByDescending(a => a.Id).Where(a => a.Name.Contains(search) || a.MobileNumber.Contains(search)).Select(c => c.ToModel(Countries, Cities, null, null));
            ViewBag.activePage = "اماكن ترفهية";
        ...
        public IActionResult Images(int id)
        {
            ...
            ViewBag.activePage = "صور اماكن ترفهية";
