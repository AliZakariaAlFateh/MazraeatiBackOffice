...
function loadRegions(cityId, selectedRegionId) {
    ...
    $.ajax({
        url: BaseUrl + '/Cottage/GetRegionsByCityId',
        type: 'GET',
        data: { cityId: cityId },
        dataType: 'json',
...
function deleteSportImage(imageId) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.post(`${BaseUrl}/Cottage/DeleteSportImage`, { id: imageId }, function (response) {
                if (response.success) {
...
function deleteSportVideo(videoId) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.post(`${BaseUrl}/Cottage/DeleteSportVideo`, { id: videoId }, function (response) {
                if (response.success) {
