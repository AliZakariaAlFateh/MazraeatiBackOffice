!(function (e, t) {
            ...
            for ("boolean" == typeof s && ((u = s), (s = arguments[a] || {}), a++), "object" == typeof s || C.isFunction(s) || (s = {}), a === l && ((s = this), a--); a < l; a++)
                if (null != (e = arguments[a]))
                    for (t in e)
                        (n = s[t]),
                            s !== (i = e[t]) &&
                            (u && i && (C.isPlainObject(i) || (r = Array.isArray(i))) ? ((o = r ? ((r = !1), n && Array.isArray(n) ? n : []) : n && C.isPlainObject(n) ? n : {}), (s[t] = C.extend(u, o, i))) : void 0 !== i && (s[t] = i));
            return s;
        }),
        C.extend({
    ...
    var b = (function (n) {
        ...
        for (e in ((d = oe.support = {}),
                    ...
                    ((s = (T = i).documentElement),
                        ...
                        (le(function (e) {
                            (s.appendChild(e).innerHTML = "<a id='" + C + "'></a><select id='" + C + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                                ...
                                e.querySelectorAll("[selected]").length || m.push("\\[" + P + "*(?:value|" + H + ")"),
                        ...
                        (d.matchesSelector = X.test((c = s.matches || s.webkitMatchesSelector || s.mozMatchesSelector || s.oMatchesSelector || s.msMatchesSelector))) &&
                        le(function (e) {
            ...
            (oe.matchesSelector = function (e, t) {
                if (((e.ownerDocument || e) !== T && E(e), (t = t.replace(K, "='$1']")), d.matchesSelector && x && !D[t + " "] && (!a || !a.test(t)) && (!m || !m.test(t))))
                    try {
                        var n = c.call(e, t);
                            ...
                            : function (e, t, n) {
                                ...
                                if (c) {
                                    ...
                                    if (((l = [y ? c.firstChild : c.lastChild]), y && h)) {
                                        for (
                                            d = (a = (i = (r = (o = (s = c)[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === S && i[1]) && i[2], s = a && c.childNodes[a];
                                        ...
                                        for (
                                            ;
                                            (s = (++a && s && s[u]) || (d = a = 0) || l.pop()) &&
                                            ((_ ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++d || (h && ((r = (o = s[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [S, d]), s !== e));
    ...
    (C.filter = function (e, t, n) {
        ...
        C.fn.extend({
            ...
            is: function (e) {
                return !!I(this, "string" == typeof e && S.test(e) ? C(e) : e || [], !1).length;
            },
        });
    var k,
        O = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ((C.fn.init = function (e, t, n) {
        var i, r;
        if (!e) return this;
        if (((n = n || k), "string" != typeof e)) return e.nodeType ? ((this[0] = e), (this.length = 1), this) : C.isFunction(e) ? (void 0 !== n.ready ? n.ready(e) : e(C)) : C.makeArray(e, this);
    ...
    (C.Callbacks = function (i) {
        ...
        C.extend({
                    ...
                    s = {
                        ...
                        then: function (t, n, i) {
                                        ...
                                        e = function () {
                                            ...
                                            if (!(r < l)) {
                                                ...
                                                (t = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                    C.isFunction(t)
                                                        ? a
                                                            ? t.call(e, u(l, o, F, a), u(l, o, q, a))
                                                            : (l++, t.call(e, u(l, o, F, a), u(l, o, q, a), u(l, o, F, o.notifyWith)))
                                                        : (s !== F && ((n = void 0), (i = [e])), (a || o.resolveWith)(n, i));
                                            }
                                        },
                                        t = a
                                            ? e
                            ...
                            return C.Deferred(function (e) {
                                o[0][3].add(u(0, e, C.isFunction(i) ? i : F, e.notifyWith)), o[1][3].add(u(0, e, C.isFunction(t) ? t : F)), o[2][3].add(u(0, e, C.isFunction(n) ? n : q));
                            }).promise();
                        },
                        promise: function (e) {
            ...
            when: function (e) {
                ...
                if (n <= 1 && (R(e, o.done(s(t)).resolve, o.reject, !n), "pending" === o.state() || C.isFunction(r[t] && r[t].then))) return o.then();
    ...
    ($.uid = 1),
        ($.prototype = {
            ...
            remove: function (e, t) {
                ...
                if (void 0 !== i) {
                    if (void 0 !== t) {
                        n = (t = Array.isArray(t) ? t.map(C.camelCase) : (t = C.camelCase(t)) in i ? [t] : t.match(P) || []).length;
                        for (; n--;) delete i[t[n]];
                    }
        ...
        C.fn.extend({
            data: function (n, e) {
                ...
                if (this.length && ((r = V.get(o)), 1 === o.nodeType && !Q.get(o, "hasDataAttrs"))) {
                    for (t = s.length; t--;) s[t] && 0 === (i = s[t].name).indexOf("data-") && ((i = C.camelCase(i.slice(5))), X(o, i, r[i]));
    ...
    function ne(e, t, n, i) {
        ...
        if (c && c[3] !== u) for (u = u || c[3], n = n || [], c = +l || 1; (c /= o = o || ".5"), C.style(e, t, c + u), o !== (o = a() / l) && 1 !== o && --s;);
                        ...
                        ? ("none" === n && ((r[o] = Q.get(i, "display") || null), r[o] || (i.style.display = "")),
                            ...
                            (r[o] =
                                ((f = u = l = void 0),
                                    (u = (a = i).ownerDocument),
                                    (c = a.nodeName),
                                    (f = ie[c]) || ((l = u.body.appendChild(u.createElement(c))), (f = C.css(l, "display")), l.parentNode.removeChild(l), "none" === f && (f = "block"), (ie[c] = f)))))
    ...
    function pe(e, t, n, i, r) {
        ...
        for (f.textContent = "", d = 0; (o = h[d++]);)
            ...
            else if (((u = C.contains(o.ownerDocument, o)), (s = ue(f.appendChild(o), "script")), u && ce(s), n)) for (c = 0; (o = s[c++]);) ae.test(o.type || "") && n.push(o);
        return f;
    }
    ...
    (C.event = {
                ...
                for (
                    ...
                    (d = g = (a = ye.exec(e[u]) || [])[1]),
                        ...
                        ((f = C.event.special[d] || {}),
                            ...
                            (f = C.event.special[d] || {}),
                            (c = C.extend({ type: d, origType: g, data: i, handler: n, guid: n.guid, selector: r, needsContext: r && C.expr.match.needsContext.test(r), namespace: p.join(".") }, o)),
        ...
        remove: function (e, t, n, i, r) {
            ...
            if (m && (l = m.events)) {
                for (u = (t = (t || "").match(P) || [""]).length; u--;)
                    if (((d = g = (a = ye.exec(t[u]) || [])[1]), (p = (a[2] || "").split(".").sort()), d)) {
        ...
        dispatch: function (e) {
            ...
            if (((a.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, a))) {
                for (s = C.event.handlers.call(this, a, u), t = 0; (r = s[t++]) && !a.isPropagationStopped();)
    ...
    function ke(e, t) {
        var n, i, r, o, s, a, l, u;
        if (1 === t.nodeType) {
            if (Q.hasData(e) && ((o = Q.access(e)), (s = Q.set(t, o)), (u = o.events))) for (r in (delete s.handle, (s.events = {}), u)) for (n = 0, i = u[r].length; n < i; n++) C.event.add(t, r, u[r][n]);
    ...
    function Oe(n, i, r, o) {
        ...
        if (f && ((t = (e = pe(i, n[0].ownerDocument, !1, n, o)).firstChild), 1 === e.childNodes.length && (e = t), t || o)) {
            for (a = (s = C.map(ue(e, "script"), Ne)).length; c < f; c++) (l = e), c !== h && ((l = C.clone(l, !0, !0)), a && C.merge(s, ue(l, "script"))), r.call(n[c], l, c);
            if (a)
                for (u = s[s.length - 1].ownerDocument, C.map(s, Ie), c = 0; c < a; c++)
                    (l = s[c]), ae.test(l.type || "") && !Q.access(l, "globalEval") && C.contains(u, l) && (l.src ? C._evalUrl && C._evalUrl(l.src) : v(l.textContent.replace(De, ""), u));
        }
        return n;
    }
    function Le(e, t, n) {
        ...
        clone: function (e, t, n) {
            ...
            if (!(m.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || C.isXMLDoc(e)))
                for (s = ue(c), i = 0, r = (o = ue(e)).length; i < r; i++)
                    (a = o[i]), (l = s[i]), void 0, "input" === (u = l.nodeName.toLowerCase()) && oe.test(a.type) ? (l.checked = a.checked) : ("input" !== u && "textarea" !== u) || (l.defaultValue = a.defaultValue);
            if (t)
                if (n) for (o = o || ue(e), s = s || ue(c), i = 0, r = o.length; i < r; i++) ke(o[i], s[i]);
                else ke(e, c);
    ...
    function Fe(e, t, n) {
        ...
        return (
            ...
            ("" !== (s = n.getPropertyValue(t) || n[t]) || C.contains(e.ownerDocument, e) || (s = C.style(e, t)),
                !m.pixelMarginRight() && He.test(s) && je.test(t) && ((i = a.width), (r = a.minWidth), (o = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = i), (a.minWidth = r), (a.maxWidth = o))),
            void 0 !== s ? s + "" : s
        );
    }
    function qe(e, t) {
    ...
    function ze(e, t, n) {
        ...
        return He.test(o)
            ? o
            : ((i = s && (m.boxSizingReliable() || o === e.style[t])), "auto" === o && (o = e["offset" + t[0].toUpperCase() + t.slice(1)]), (o = parseFloat(o) || 0) + Ve(e, t, n || (s ? "border" : "content"), i, r) + "px");
    }
    ...
    C.extend({
        ...
        C.each(["height", "width"], function (e, s) {
            C.cssHooks[s] = {
                get: function (e, t, n) {
                    if (t)
                        return !Re.test(C.css(e, "display")) || (e.getClientRects().length && e.getBoundingClientRect().width)
                            ? ze(e, s, n)
                            : te(e, We, function () {
                                return ze(e, s, n);
                            });
                ...
                set: function (e, t, n) {
                    var i,
                        r = n && Pe(e),
                        o = n && Ve(e, s, n, "border-box" === C.css(e, "boxSizing", !1, r), r);
    ...
    function st(o, e, t) {
        var n,
            ...
            l = function () {
                if (s) return !1;
                for (var e = Xe || it(), t = Math.max(0, u.startTime + u.duration - e), n = 1 - (t / u.duration || 0), i = 0, r = u.tweens.length; i < r; i++) u.tweens[i].run(n);
    ...
    (C.Animation = C.extend(st, {
        ...
        tweener: function (e, t) {
            for (var n, i = 0, r = (e = C.isFunction(e) ? ((t = e), ["*"]) : e.match(P)).length; i < r; i++) (n = e[i]), (st.tweeners[n] = st.tweeners[n] || []), st.tweeners[n].unshift(t);
        },
        prefilters: [
            function (e, t, n) {
                var i,
                ...
                if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(d))
                    for (i in (f &&
                        ...
                        ((n.overflow = [p.overflow, p.overflowX, p.overflowY]),
                            ...
                            "none" === (c = C.css(e, "display")) && (u ? (c = u) : (re([e], !0), (u = e.style.display || u), (c = C.css(e, "display")), re([e]))),
                        ...
                        d))
                        l ||
                            (m ? "hidden" in m && (g = m.hidden) : (m = Q.access(e, "fxshow", { display: u })),
                                o && (m.hidden = !g),
                                g && re([e], !0),
                                h.done(function () {
                                    for (i in (g || re([e]), Q.remove(e, "fxshow"), d)) C.style(e, i, d[i]);
                                })),
                            (l = ot(g ? m[i] : 0, i, h)),
        ...
        (C.fx.tick = function () {
            var e,
                t = 0,
                n = C.timers;
            for (Xe = C.now(); t < n.length; t++) (e = n[t])() || n[t] !== e || n.splice(t--, 1);
            ...
            toggleClass: function (r, t) {
                ...
                return "boolean" == typeof t && "string" === o
                    ...
                    : C.isFunction(r)
                        ...
                        : this.each(function () {
                            var e, t, n, i;
                            if ("string" === o) for (t = 0, n = C(this), i = r.match(P) || []; (e = i[t++]);) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
                            else (void 0 !== r && "boolean" !== o) || ((e = ht(this)) && Q.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === r ? "" : Q.get(this, "__className__") || ""));
                        });
            },
            hasClass: function (e) {
                var t,
        ...
        trigger: function (e, t, n, i) {
            ...
            if (
                ...
                if (!i && !c.noBubble && !C.isWindow(n)) {
                    for (a = c.delegateType || h, pt.test(a + h) || (o = o.parentNode); o; o = o.parentNode) f.push(o), (s = o);
                    s === (n.ownerDocument || x) && f.push(s.defaultView || s.parentWindow || T);
                }
                for (r = 0; (o = f[r++]) && !e.isPropagationStopped();)
                    (e.type = 1 < r ? a : c.bindType || h),
                        (u = (Q.get(o, "events") || {})[e.type] && Q.get(o, "handle")) && u.apply(o, t),
                        (u = l && o[l]) && u.apply && K(o) && ((e.result = u.apply(o, t)), !1 === e.result && e.preventDefault());
                return (
                    (e.type = h),
                    i ||
                    ...
                    !K(n) ||
                    (l && C.isFunction(n[h]) && !C.isWindow(n) && ((s = n[l]) && (n[l] = null), n[(C.event.triggered = h)](), (C.event.triggered = void 0), s && (n[l] = s))),
                    e.result
                );
            }
        },
    ...
    (Ot.href = gt.href),
        C.extend({
            ...
            ajax: function (e, t) {
                ...
                var c,
                    ...
                    E = {
                        ...
                        getResponseHeader: function (e) {
                            var t;
                            if (p) {
                                if (!n) for (n = {}; (t = St.exec(h));) n[t[1].toLowerCase()] = t[2];
                                t = n[e.toLowerCase()];
                            }
                ...
                if ((m.data && m.processData && "string" != typeof m.data && (m.data = C.param(m.data, m.traditional)), jt(Nt, m, t, E), p)) return E;
                for (r in ((g = C.event && m.global) && 0 == C.active++ && C.event.trigger("ajaxStart"),
                    ...
                    E.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + kt + "; q=0.01" : "") : m.accepts["*"]),
                    m.headers))
                    E.setRequestHeader(r, m.headers[r]);
                if (m.beforeSend && (!1 === m.beforeSend.call(v, E, m) || p)) return E.abort();
                if (((l = "abort"), b.add(m.complete), E.done(m.success), E.fail(m.error), (c = jt(It, m, t, E)))) {
                                    ...
                                    ((o = s = i.onload = i.onerror = i.onabort = i.onreadystatechange = null),
                                        "abort" === e
                                            ...
                                            : "error" === e
                                                ...
                                                : t(Pt[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? { binary: i.response } : { text: i.responseText }, i.getAllResponseHeaders()));
                            };
                        }),
                            (i.onload = o()),
                            (s = i.onerror = o("error")),
    ...
    C.ajaxSetup({
        ...
        C.ajaxPrefilter("json jsonp", function (e, t, n) {
            ...
            if (s || "jsonp" === e.dataTypes[0])
                return (
                    ...
                    n.always(function () {
                        void 0 === r ? C(T).removeProp(i) : (T[i] = r), e[i] && ((e.jsonpCallback = t.jsonpCallback), Rt.push(i)), o && C.isFunction(r) && r(o[0]), (o = r = void 0);
                    }),
                    "script"
                );
        }),
        (m.createHTMLDocument = (((qt = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === qt.childNodes.length)),
        ...
        C.each(["top", "left"], function (e, n) {
            C.cssHooks[n] = qe(m.pixelPosition, function (e, t) {
                if (t) return (t = Fe(e, n)), He.test(t) ? C(e).position()[n] + "px" : t;
            });
        }),
    ...
    (function (e, t) {
        ...
        var r = "alert",
            ...
            a = "." + o,
            u = p.fn[r],
            c = { CLOSE: "close" + a, CLOSED: "closed" + a, CLICK_DATA_API: "click" + a + ".data-api" },
            f = "alert",
            h = "fade",
            d = "show",
            m = (function () {
        ...
        p(document).on(c.CLICK_DATA_API, '[data-dismiss="alert"]', m._handleDismiss(new m())),
            ...
            ae = (function () {
                ...
                return (
                    ...
                    (e._addTouchEventListeners = function () {
                        ...
                        if (this._touchSupported) {
                            ...
                            p(this._element.querySelectorAll(te)).on(U.DRAG_START, function (e) {
                                ...
                                this._pointerEvent
                                    ? (p(this._element).on(U.POINTERDOWN, function (e) {
                                        return t(e);
                                    }),
                                    ...
                                    : (p(this._element).on(U.TOUCHSTART, function (e) {
                                        return t(e);
                                    }),
                    ...
                    (e._slide = function (e, t) {
                        ...
                        if (((r = e === R ? ((n = z), (i = Y), W) : ((n = V), (i = X), B)), l && p(l).hasClass($))) this._isSliding = !1;
        ...
        var le = "collapse",
            ...
            pe = { SHOW: "show" + ce, SHOWN: "shown" + ce, HIDE: "hide" + ce, HIDDEN: "hidden" + ce, CLICK_DATA_API: "click" + ce + ".data-api" },
            ge = "show",
            me = "collapse",
            ve = "collapsing",
            ye = "collapsed",
        ...
        for (var xe = "undefined" != typeof window && "undefined" != typeof document, Ce = ["Edge", "Trident", "Firefox"], Se = 0, De = 0; De < Ce.length; De += 1)
        ...
        function Ve(e) {
            ...
            if (l || u) {
                var c = Ie(e);
                (l -= Me(c, "x")), (u -= Me(c, "y")), (r.width -= l), (r.height -= u);
            }
            return Qe(r);
        }
        function ze(e, t) {
                        ...
                        return (
                            b.forEach(function (e, t) {
                                ...
                                (s || f || d) &&
                                    ((p.flipped = !0),
                                        (s || f) && (v = b[t + 1]),
                                        d && (_ = "end" === (n = _) ? "start" : "start" === n ? "end" : n),
                                        (p.placement = v + (_ ? "-" + _ : "")),
                        ...
                        var s,
                            ...
                            x =
                                ((s = e),
                                    ...
                                    (p = f(c.width)),
                                    (g = f(u.width)),
                                    (m = -1 !== ["left", "right"].indexOf(s.placement)),
                                    (v = -1 !== s.placement.indexOf("-")),
                                    (_ = a ? f : d),
                                    { left: (y = a ? (m || v || p % 2 == g % 2 ? f : h) : d)(p % 2 == 1 && g % 2 == 1 && !v && a ? u.left - 1 : u.left), top: _(u.top), bottom: _(u.bottom), right: y(u.right) }),
                            ...
                            N = void 0;
                        if (
                            ((N = "bottom" === C ? ("HTML" === w.nodeName ? -w.clientHeight + x.bottom : -E.height + x.bottom) : x.top),
                                (A = "right" === S ? ("HTML" === w.nodeName ? -w.clientWidth + x.right : -E.width + x.right) : x.left),
                                b && D)
                        )
                            (T[D] = "translate3d(" + A + "px, " + N + "px, 0)"), (T[C] = 0), (T[S] = 0), (T.willChange = "transform");
                        else {
                            var I = "bottom" === C ? -1 : 1,
                                k = "right" === S ? -1 : 1;
                            ...
                            value: function () {
                                return function () {
                                    if (!this.state.isDestroyed) {
                                        ...
                                        (e.offsets.reference = Je(this.state, this.popper, this.reference, this.options.positionFixed)),
        ...
        var Et = "dropdown",
            ...
            At = { HIDE: "hide" + xt, HIDDEN: "hidden" + xt, SHOW: "show" + xt, SHOWN: "shown" + xt, CLICK: "click" + xt, CLICK_DATA_API: "click" + xt + Ct, KEYDOWN_DATA_API: "keydown" + xt + Ct, KEYUP_DATA_API: "keyup" + xt + Ct },
            Nt = "disabled",
            It = "show",
            kt = "dropup",
            Ot = "dropright",
            ...
            Yt = (function () {
                ...
                return (
                                ...
                                if ((p(e).trigger(i), !i.isDefaultPrevented())) {
                                    if (!this._inNavbar) {
                                        ...
                                        "parent" === this._config.reference ? (r = e) : g.isElement(this._config.reference) && ((r = this._config.reference), void 0 !== this._config.reference.jquery && (r = this._config.reference[0])),
                                            ...
                                            (this._popper = new wt(r, this._menu, this._getPopperConfig()));
                                    }
                                    "ontouchstart" in document.documentElement && 0 === p(e).closest(Rt).length && p(document.body).children().on("mouseover", null, p.noop),
                                        ...
                                        p(e).toggleClass(It).trigger(p.Event(At.SHOWN, n));
                                }
                            }
                        }
                    }),
                                    ...
                                    if (p(r).hasClass(It) && !(e && (("click" === e.type && /input|textarea/i.test(e.target.tagName)) || ("keyup" === e.type && 9 === e.which)) && p.contains(r, e.target))) {
                                        ...
                                        p(r).trigger(l),
                                            ...
                                            ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop),
                                                ...
                                                p(a).removeClass(It),
                                                p(r).removeClass(It).trigger(p.Event(At.HIDDEN, s)));
                                    }
                                }
                            }
                    }),
                    ...
                    (u._dataApiKeydownHandler = function (e) {
                        if (
                            (/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || (27 !== e.which && ((40 !== e.which && 38 !== e.which) || p(e.target).closest(qt).length))) : Dt.test(e.which)) &&
                            (e.preventDefault(), e.stopPropagation(), !this.disabled && !p(this).hasClass(Nt))
                        ) {
                ...
                return (
                    ...
                    (e._showElement = function (e) {
                        ...
                        (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE) || document.body.appendChild(this._element),
                            ...
                            p(this._dialog).hasClass(rn) ? (this._dialog.querySelector(fn).scrollTop = 0) : (this._element.scrollTop = 0),
        ...
        var En = "tooltip",
            ...
            In = { AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left" },
            kn = {
                animation: !0,
            ...
            Un = (function () {
                ...
                return (
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            p(r).data(this.constructor.DATA_KEY, this),
                                ...
                                (this._popper = new wt(this.element, r, {
                                    placement: a,
                                    modifiers: { offset: this._getOffset(), flip: { behavior: this.config.fallbackPlacement }, arrow: { element: qn }, preventOverflow: { boundariesElement: this.config.boundary } },
                                    onCreate: function (e) {
                    ...
                    (e.setContent = function () {
                        ...
                        this.setElementContent(p(e.querySelectorAll(Fn)), this.getTitle()), p(e).removeClass(Hn + " " + Pn);
                    }),
                    (e.setElementContent = function (e, t) {
                        "object" != typeof t || (!t.nodeType && !t.jquery)
                            ? this.config.html
                                ? (this.config.sanitize && (t = wn(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t))
                                : e.text(t)
                            : this.config.html
                    ...
                    (e._setListeners = function () {
                        ...
                        this.config.trigger.split(" ").forEach(function (e) {
                            if ("click" === e)
                                ...
                                var t = e === Rn ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
                                    n = e === Rn ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT;
                                p(i.element)
                    ...
                    (e._enter = function (e, t) {
                        ...
                        (t = t || p(e.currentTarget).data(n)) || ((t = new this.constructor(e.currentTarget, this._getDelegateConfig())), p(e.currentTarget).data(n, t)),
                            e && (t._activeTrigger["focusin" === e.type ? Mn : Rn] = !0),
                            p(t.getTipElement()).hasClass(Pn) || t._hoverState === On
                                ? (t._hoverState = On)
                    ...
                    (e._leave = function (e, t) {
                        var n = this.constructor.DATA_KEY;
                        (t = t || p(e.currentTarget).data(n)) || ((t = new this.constructor(e.currentTarget, this._getDelegateConfig())), p(e.currentTarget).data(n, t)),
                            e && (t._activeTrigger["focusout" === e.type ? Mn : Rn] = !1),
                    ...
                    (e._getConfig = function (e) {
                        ...
                        return (
                            ...
                            g.typeCheckConfig(En, e, this.constructor.DefaultType),
                            e.sanitize && (e.template = wn(e.template, e.whiteList, e.sanitizeFn)),
                            e
                        );
                    }),
        ...
        var Kn = "popover",
            ...
            Xn = l({}, Un.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
            Gn = l({}, Un.DefaultType, { content: "(string|element|function)" }),
            Jn = "fade",
            Zn = "show",
            ei = ".popover-header",
            ti = ".popover-body",
            ...
            Ti = (function () {
                function n(e, t) {
                    ...
                    (this._element = e),
                        ...
                        (this._config = this._getConfig(t)),
                        (this._selector = this._config.target + " " + gi + "," + this._config.target + " " + vi + "," + this._config.target + " " + _i),
                        (this._offsets = []),
                        (this._targets = []),
                ...
                return (
                    ...
                    (e._activate = function (t) {
                        ...
                        n.hasClass(fi)
                            ? (n.closest(yi).find(bi).addClass(hi), n.addClass(hi))
                            : (n.addClass(hi),
                                n
                                    .parents(pi)
                                    .prev(gi + ", " + vi)
                            ...
                            p(this._scrollElement).trigger(ci.ACTIVATE, { relatedTarget: t });
                    }),
                    (e._clear = function () {
                        [].slice
                            .call(document.querySelectorAll(this._selector))
        ...
        var xi = "bs.tab",
            Ci = "." + xi,
            Si = p.fn.tab,
            Di = { HIDE: "hide" + Ci, HIDDEN: "hidden" + Ci, SHOW: "show" + Ci, SHOWN: "shown" + Ci, CLICK_DATA_API: "click" + Ci + ".data-api" },
            Ai = "dropdown-menu",
            Ni = "active",
            Ii = "disabled",
            ki = "fade",
                ...
                return (
                    (e.show = function () {
                        ...
                        if (!((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Ni)) || p(this._element).hasClass(Ii))) {
                            ...
                            var s = p.Event(Di.HIDE, { relatedTarget: this._element }),
        ...
        var Wi = "toast",
            ...
            Ui = "." + Bi,
            Ki = p.fn[Wi],
            $i = { CLICK_DISMISS: "click.dismiss" + Ui, HIDE: "hide" + Ui, HIDDEN: "hidden" + Ui, SHOW: "show" + Ui, SHOWN: "shown" + Ui },
            Qi = "fade",
            Vi = "hide",
            zi = "show",
            Yi = "showing",
