        ...
        activate: function () {
            ...
            $(window).on("click", function (e) {
                ...
                "i" === e.target.nodeName.toLowerCase() && (a = $(e.target).parent()),
                    !a.hasClass("bars") && i.isOpen() && 0 === a.parents("#leftsidebar, .mini-sidebar").length && (a.hasClass("js-right-sidebar") || o.fadeOut(), t.removeClass("overlay-open"));
            }),
...
function CustomScrollbar() {
    $(".mini-sidebar .custom_scroll").slimscroll({ height: "calc(100vh - 20px)", color: "rgba(0,0,0,0.2)", position: "right", size: "2px", alwaysVisible: !1, borderRadius: "3px", railBorderRadius: "0" }),
        $(".mini-bar .sidebar .menu .list").slimscroll({ height: "calc(100vh - 270px)", color: "rgba(0,0,0,0.2)", position: "right", size: "2px", alwaysVisible: !1, borderRadius: "3px", railBorderRadius: "0" }),
        $(".sidebar .menu .list").slimscroll({ height: "calc(100vh - 0px)", color: "rgba(0,0,0,0.2)", position: "right", size: "2px", alwaysVisible: !1, borderRadius: "3px", railBorderRadius: "0" }),
        $(".navbar-left .dropdown-menu .body .menu").slimscroll({ height: "300px", color: "rgba(0,0,0,0.2)", size: "3px", alwaysVisible: !1, borderRadius: "3px", railBorderRadius: "0" }),
        $(".chat-widget").slimscroll({ height: "300px", color: "rgba(0,0,0,0.4)", size: "2px", alwaysVisible: !1, borderRadius: "3px", railBorderRadius: "2px" }),
        $(".right-sidebar .slim_scroll").slimscroll({ height: "calc(100vh - 60px)", color: "rgba(0,0,0,0.4)", size: "2px", alwaysVisible: !1, borderRadius: "3px", railBorderRadius: "0" });
}
$(function () {
    "use strict";
