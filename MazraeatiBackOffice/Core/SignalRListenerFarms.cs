...
namespace MazraeatiBackOffice.Core
{
    public class SignalRListenerFarms
    {
        ...
        {
            //this code for Signal R may you can do modifiy on it ...
            _connection = new HubConnectionBuilder()
                .WithUrl("http://5.189.180.190/MazareatiAPI/farmHub")  //API Hub URL For Pro
                //.WithUrl("http://localhost:61366/farmHub") // API Hub URL For Dev
