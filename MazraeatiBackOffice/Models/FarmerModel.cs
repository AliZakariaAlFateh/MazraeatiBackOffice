...
namespace MazraeatiBackOffice.Models
{
    public class FarmerModel
    {
        ...
        [DisplayName("اسم المنطقة بالعربى")] //for validation ...
        //[Required(ErrorMessage = "برجاء تعبئة الحقل")] //to be required ...
        ...
        //public string StatusFarmAppUserText { get; set; }
        [DisplayName("حالة المزرعة")]
        //public FarmAppUserStatus statusFarmAppUser { get; set; } = FarmAppUserStatus.Active;
        public int statusFarmAppUser { get; set; } = 0;
        [DisplayName("الرقم الكودى للمزرعة")]
        public string? SerialFarmKey { get; set; }
        public string MobileOwnerAppUser { get; internal set; }
